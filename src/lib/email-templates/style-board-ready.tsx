...
const StyleBoardReady = ({
  ...
  <Html lang="en" dir="ltr">
    ...
    <Preview>
      {projectTitle
        ? `${projectTitle} — your style board from the Hive`
        : "Your style board is ready."}
    </Preview>
    <Body style={main}>
      <Container style={container}>
        <Text style={eyebrow}>ECLECTIC HIVE · STYLE BOARD</Text>
        <Heading style={h1}>{projectTitle ?? "A curation for you."}</Heading>
        <Text style={lede}>
        ...
        <Section style={{ marginTop: 32, marginBottom: 8 }}>
          <Button href={boardUrl} style={cta}>
            VIEW YOUR BOARD →
          </Button>
        </Section>
        ...
        <Section style={{ marginTop: 28 }}>
          <Button href={boardUrl} style={ctaGhost}>
            OPEN THE FULL BOARD
          </Button>
        </Section>
        ...
        <Text style={footer}>REPLY TO THIS EMAIL WITH THOUGHTS · INFO@ECLECTICHIVE.COM</Text>
      </Container>
    </Body>
  </Html>
);
