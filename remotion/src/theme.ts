...
export const PRODUCTS: Product[] = [
  {
    src: "products/01-lars-table.png",
    title: "LARS BLEACHED OAK TABLE",
    category: "Tables",
    hero: true,
  },
  {
    src: "products/02-botond-chandelier.png",
    title: "BOTOND WALNUT CHANDELIER",
    category: "Lighting",
  },
  ...
  {
    src: "products/07-amalia-votive.png",
    title: "AMALIA SMOKE GLASS VOTIVE",
...
export const SWATCH_ORIGINS: SwatchOrigin[] = [
  { kind: "inspo", idx: 0, x: 0.5, y: 0.3 }, // Limestone     ← Amangiri
  { kind: "product", idx: 0, x: 0.5, y: 0.5 }, // Bleached Oak  ← Lars
  { kind: "product", idx: 4, x: 0.5, y: 0.5 }, // Travertine    ← Tibur
  { kind: "product", idx: 2, x: 0.5, y: 0.5 }, // Cane          ← Fawn
  { kind: "inspo", idx: 2, x: 0.5, y: 0.5 }, // Clay Ember    ← Dos Mas
  { kind: "inspo", idx: 1, x: 0.5, y: 0.5 }, // Blue Smoke    ← Lynden
  { kind: "product", idx: 1, x: 0.5, y: 0.5 }, // Walnut        ← Botond
  { kind: "inspo", idx: 4, x: 0.5, y: 0.5 }, // Char          ← Brooke
];
