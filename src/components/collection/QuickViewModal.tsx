  ...
  return createPortal(
    ...
    >
      ...
      <motion.div
        ...
        className="relative w-full h-[100dvh] md:h-[86dvh] md:max-h-[860px] md:max-w-[1200px] text-charcoal shadow-2xl overflow-hidden grid grid-rows-[minmax(0,auto)_minmax(0,1fr)] md:rounded-none rounded-t-2xl"
        style={{
