...
export const anguillaMicheleRagoGalleryHero: GalleryImage = {
  src: galleriesUrl("ANGUILLA-MICHELLE-RAGO/.keep"),
  alt: "Anguilla — Michelle Rago Destinations cover",
};
...
export const brushCreekLoveThisDayGalleryPaths = [
  "BRUSH-CREEK-LOVE-THIS-DAY/.keep",
...
export const brushCreekLoveThisDayGalleryHero: GalleryImage = {
  src: galleriesUrl("BRUSH-CREEK-LOVE-THIS-DAY/.keep"),
  alt: "Brush Creek Ranch — Love This Day cover",
};
...
export const brushCreekDiwanGalleryHero: GalleryImage = {
  src: galleriesUrl("BRUSH-CREEK-DIWAN/.keep"),
  alt: "Brush Creek Ranch — Diwan by Design cover",
};
...
export const bishopsLodge42NorthGalleryHero: GalleryImage = {
  src: galleriesUrl("BISHOPS-LODGE-42-NORTH/.keep"),
  alt: "Bishop's Lodge — 42 North cover",
};
...
export const encoreBostonDiwanGalleryHero: GalleryImage = {
  src: galleriesUrl("ENCORE-BOSTON-DIWAN/.keep"),
  alt: "The Encore — Diwan by Design cover",
};
...
export const privateResidenceTxCinergyGalleryPaths = [
  "PRIVATE-RESIDENCE-TX-CINERGY/.keep",
...
export const privateResidenceTxCinergyGalleryHero: GalleryImage = {
  src: galleriesUrl("PRIVATE-RESIDENCE-TX-CINERGY/.keep"),
  alt: "Private Residence, TX — Cinergy Works cover",
};
...
export const blackberryFarmsEastonGalleryHero: GalleryImage = {
  src: galleriesUrl("BLACKBERRY-FARMS-EASTON/.keep"),
  alt: "Blackberry Farms — Easton Events cover",
};
...
export const fourSeasonsVailCassieLamereGalleryPaths = [
  "FOUR-SEASONS-VAIL-CASSIE-LAMERE/.keep",
...
export const fourSeasonsVailCassieLamereGalleryHero: GalleryImage = {
  src: galleriesUrl("FOUR-SEASONS-VAIL-CASSIE-LAMERE/.keep"),
  alt: "Four Seasons Vail — Cassie LaMere Events cover",
};
