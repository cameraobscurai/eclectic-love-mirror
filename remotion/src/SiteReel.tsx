    ...
    <AbsoluteFill style={{ background: CHARCOAL, opacity: opacity * exit }}>
      ...
      <div
        style={{
          ...
          left: 96,
          bottom: 64,
          ...labelStyle(11, "rgba(255,255,255,0.7)"),
        }}
      >
        WINTER · ASPEN · 2026
      </div>
    ...
    <AbsoluteFill style={{ background: WHITE, opacity }}>
      ...
      <div
        style={{
          ...
          ...labelStyle(10, "rgba(26,26,26,0.45)"),
        }}
      >
        04 / 05
      </div>
      ...
      >
        <div style={{ flex: "0 0 68%", overflow: "hidden", position: "relative" }}>
          <Img
            src={staticFile(manifest.home.poster04)}
          ...
          <div
            style={{
              ...
              bottom: 16,
              left: 16,
              ...labelStyle(9, "rgba(255,255,255,0.85)"),
            }}
          >
            04 · AUTUMN
          </div>
    ...
    <AbsoluteFill style={{ background: WHITE, opacity: opacity * exit }}>
      ...
      <div
        style={{
          ...
          left: 96,
          opacity: labelOp,
          ...labelStyle(10, "rgba(26,26,26,0.55)"),
        }}
      >
...
const MATCH_TILE_IDX = Math.max(
  0,
  GRID_TILES.findIndex((t) => t.category === "seating"),
);
const MATCH_TILE = GRID_TILES[MATCH_TILE_IDX];

const ArchiveGrid: React.FC<{ progress: number; tonalProgress: number }> = ({
  progress,
  tonalProgress,
}) => {
  // Tonal sort target: textiles ordered light → dark
  const textiles = GRID_TILES.map((t, i) => ({ t, i }))
    ...
    >
      {GRID_TILES.map((tile, i) => {
        ...
        if (textilePosMap.has(i)) {
          ...
          const targetCol =
            textiles.length <= 1 ? c : (targetIdx / (textiles.length - 1)) * (GRID_COLS - 1);
        ...
        return (
          <div
            ...
            style={{
              ...
              background: "#f7f5f1",
              outline: isMatch
                ? `1px solid rgba(26,26,26,${0.15 + 0.55 * tonalProgress})`
                : "1px solid rgba(26,26,26,0.04)",
...
const S04Archive: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: WHITE, opacity: opacity * exit }}>
      <div
        style={{
          transform: `translate(${enterX}px, ${drift}px)`,
          height: "100%",
          position: "relative",
        }}
      >
        ...
        <div
          style={{
            ...
            top: 24,
            right: 80,
            ...labelStyle(10, "rgba(26,26,26,0.65)"),
          }}
        >
          625 / 625
        </div>
    ...
    <AbsoluteFill style={{ background: WHITE, opacity: opacity * exit }}>
      ...
      <div
        style={{
          ...
          opacity: labelOp,
          ...labelStyle(9, "rgba(26,26,26,0.55)"),
        }}
      >
        <span>#F2F1E9</span>
        <span>#C7B6A1</span>
...
const S06Macro: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: WHITE, opacity }}>
      ...
      >
        {MATCH_TILE.category.replace(/-/g, " ").toUpperCase()} ·{" "}
        {String(MATCH_TILE_IDX + 1).padStart(3, "0")} / 625
      </div>
      <div
        style={{
          position: "absolute",
    ...
    >
      ...
      >
        ...
        <div
          style={{
            ...labelStyle(10, "rgba(26,26,26,0.55)"),
            opacity: easeRange(frame, [35, 60], [0, 1]),
          }}
        >
    ...
    <AbsoluteFill style={{ background: CHARCOAL, opacity: opacity * exit }}>
      <div
        style={{
          ...
          top: 56,
          left: 96,
          ...labelStyle(10, "rgba(255,255,255,0.55)"),
        }}
      >
        /ATELIER
      </div>
        ...
        {panels.map((p, i) => {
          ...
          return (
            ...
            >
              ...
              />
              <div
                style={{ position: "absolute", bottom: 16, left: 16, ...displayStyle(20, WHITE) }}
              >
                {p.verb}
              </div>
            </div>
    ...
    <AbsoluteFill style={{ background: CHARCOAL, opacity: opacity * exit }}>
      ...
      <div
        style={{
          ...
          top: 56,
          left: 96,
          ...labelStyle(10, "rgba(255,255,255,0.7)"),
        }}
      >
    ...
    <AbsoluteFill style={{ background: WHITE, opacity: opacity * exit }}>
      ...
      >
        {inspoSrcs.map((src, i) => {
          ...
          return (
            <div
              key={i}
              style={{ flex: 1, overflow: "hidden", opacity: op, transform: `translateY(${ty}px)` }}
            >
              <Img
                src={staticFile(src)}
                style={{ width: "100%", height: "100%", objectFit: "cover" }}
      ...
      <div
        style={{
          ...
          background: WHITE,
          padding: "0 8px",
          ...labelStyle(9, "rgba(26,26,26,0.5)"),
        }}
      >
        01 INSPO
      </div>
      ...
      <div
        style={{
          ...
          top: 520,
          left: 96,
          ...labelStyle(9, "rgba(26,26,26,0.45)"),
        }}
      >
        02 PALETTE — DETECTED
      </div>
      <div
        style={{ position: "absolute", top: 552, left: 96, right: 96, display: "flex", gap: 20 }}
      >
        {swatchColors.map((c, i) => {
          ...
          return (
            ...
            >
              <span
                style={{ ...labelStyle(8, i > 2 ? "rgba(255,255,255,0.7)" : "rgba(26,26,26,0.7)") }}
              >
                {c.toUpperCase()}
              </span>
            </div>
  ...
  return (
    <AbsoluteFill style={{ background: WHITE, opacity: opacity * exit }}>
      ...
      >
        <div
          style={{
            ...labelStyle(11, "rgba(26,26,26,0.55)"),
            opacity: easeRange(frame, [10, 25], [0, 1]),
          }}
        >
          ✓ BRIEF RECEIVED
        </div>
      ...
      >
        ...
        <div
          style={{
            ...
            height: 1,
            background: SAND,
            opacity: easeRange(frame, [8, 18], [0, 1]),
          }}
        />
        ...
        <div
          style={{
            ...labelStyle(10, "rgba(212,205,196,0.6)"),
            opacity: easeRange(frame, [14, 24], [0, 1]),
            marginTop: 24,
          }}
        >
          ECLECTICHIVE.COM
...
// ─────────────────────────────────────────────────────────────────────────
const Hairline: React.FC<{ at: number; reverse?: boolean; dark?: boolean }> = ({
  at,
  reverse,
  dark,
}) => {
...
export const SiteReel: React.FC = () => {
  return (
    <AbsoluteFill style={{ background: WHITE, fontFamily: BODY }}>
      <Sequence from={T.S01_INVITE[0]} durationInFrames={T.S01_INVITE[1] - T.S01_INVITE[0]}>
        <S01Invitation />
      </Sequence>
      <Sequence from={T.S02_HOME[0]} durationInFrames={T.S02_HOME[1] - T.S02_HOME[0]}>
        <S02Home />
      </Sequence>
      <Sequence from={T.S03_GRID[0]} durationInFrames={T.S03_GRID[1] - T.S03_GRID[0]}>
        <S03GridConstruct />
      </Sequence>
      <Sequence from={T.S04_ARCHIVE[0]} durationInFrames={T.S04_ARCHIVE[1] - T.S04_ARCHIVE[0]}>
        <S04Archive />
      </Sequence>
      <Sequence from={T.S05_TONAL[0]} durationInFrames={T.S05_TONAL[1] - T.S05_TONAL[0]}>
        <S05Tonal />
      </Sequence>
      <Sequence from={T.S06_MACRO[0]} durationInFrames={T.S06_MACRO[1] - T.S06_MACRO[0]}>
        <S06Macro />
      </Sequence>
      <Sequence from={T.S07_SWATCH[0]} durationInFrames={T.S07_SWATCH[1] - T.S07_SWATCH[0]}>
        <S07Swatch />
      </Sequence>
      <Sequence from={T.S08_ATELIER[0]} durationInFrames={T.S08_ATELIER[1] - T.S08_ATELIER[0]}>
        <S08Atelier />
      </Sequence>
      <Sequence from={T.S09_SKETCH[0]} durationInFrames={T.S09_SKETCH[1] - T.S09_SKETCH[0]}>
        <S09Sketch />
      </Sequence>
      <Sequence from={T.S10_GALLERY[0]} durationInFrames={T.S10_GALLERY[1] - T.S10_GALLERY[0]}>
        <S10Gallery />
      </Sequence>
      <Sequence from={T.S11_BRIEF[0]} durationInFrames={T.S11_BRIEF[1] - T.S11_BRIEF[0]}>
        <S11Brief />
      </Sequence>
      <Sequence from={T.S12_SUBMIT[0]} durationInFrames={T.S12_SUBMIT[1] - T.S12_SUBMIT[0]}>
        <S12Submit />
      </Sequence>
      <Sequence from={T.S13_COVERS[0]} durationInFrames={T.S13_COVERS[1] - T.S13_COVERS[0]}>
        <S13Covers />
      </Sequence>
      <Sequence from={T.S14_LOCKUP[0]} durationInFrames={T.S14_LOCKUP[1] - T.S14_LOCKUP[0]}>
        <S14Lockup />
      </Sequence>
      {/* Persistent overlays */}
      <Hairline at={60} dark /> {/* opening hairline over invitation */}
      <Hairline at={1572} reverse dark />
      {/* closing hairline over lockup */}
      <FilmGrain />
      <Chapter />
    </AbsoluteFill>
  );
