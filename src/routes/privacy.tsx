...
const SECTION_LABEL = "text-[11px] uppercase tracking-[0.28em] text-charcoal/55 mb-4";
    ...
    >
      <div className="max-w-3xl mx-auto px-6 lg:px-12">
        ...
        <header className="pb-12">
          <p className="text-[11px] uppercase tracking-[0.32em] text-charcoal/50">PRIVACY POLICY</p>
        ...
        <section className={SECTION_WRAP}>
          <div className={PROSE}>
            <p>
              ...
              and discloses information collected from users (each, a &ldquo;User&rdquo;) of the
              website (&ldquo;Site&rdquo;). This privacy policy applies to the Site and all products
              and services offered by ECLECTIC HIVE.
            </p>
          </div>
        </section>
        ...
        <section className={`${SECTION_WRAP} mt-12`}>
          ...
          <div className={PROSE}>
            <p>
              ...
              appropriate, email address. Users may, however, visit our Site anonymously. We will
        ...
        <section className={`${SECTION_WRAP} mt-12`}>
          ...
          <div className={PROSE}>
            <p>
              Our Site may use &ldquo;cookies&rdquo; to enhance User experience. User&apos;s web
        ...
        <section className={`${SECTION_WRAP} mt-12`}>
          ...
          <div className={PROSE}>
            <p>
              ECLECTIC HIVE may collect and use Users personal information for the following
              purposes:
            </p>
            <p>
              <strong>To improve customer service.</strong> Information you provide helps us respond
              to your customer service requests and support needs more efficiently.
            </p>
            <p>
              <strong>To personalize user experience.</strong> We may use information in the
              aggregate to understand how our Users as a group use the services and resources
              provided on our Site.
            </p>
            <p>
              <strong>To send periodic emails.</strong> We may use the email address to send User
              information and updates pertaining to their order. It may also be used to respond to
              their inquiries, questions, and/or other requests. If User decides to opt-in to our
              mailing list, they will receive emails that may include company news, updates, related
              product or service information, etc. If at any time the User would like to unsubscribe
              from receiving future emails, we include detailed unsubscribe instructions at the
        ...
        <section className={`${SECTION_WRAP} mt-12`}>
          ...
          <div className={PROSE}>
            <p>
              ...
              websites which have a link to our Site, is subject to that website&apos;s own terms
              and policies.
            </p>
          </div>
        </section>
        ...
        <section className={`${SECTION_WRAP} mt-12`}>
          ...
          <div className={PROSE}>
            <p>
              ECLECTIC HIVE has the discretion to update this privacy policy at any time. When we
              do, we will revise the updated date at the bottom of this page. We encourage Users to
