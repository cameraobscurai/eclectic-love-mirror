...
// ---------------------------------------------------------------------------
// /admin/dashboard — the original AdminDashboard body, moved verbatim from
// admin.tsx when /admin became the BOH home. Still reachable, not on the BOH
// tool rail (see PATCHES.md §3). If Jill/Adrienne visit it after a couple
...
export const Route = createFileRoute("/admin/dashboard")({
  ...
  head: () => ({
    meta: [
      { title: "Dashboard · Admin · Eclectic Hive" },
