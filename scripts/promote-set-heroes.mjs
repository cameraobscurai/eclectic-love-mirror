...
console.log(
  `Skipped — already_set:${skipped.already_set}  no_set:${skipped.no_set}  single_image:${skipped.single_image}\n`,
);
...
fs.writeFileSync(
  "/tmp/promote-set-heroes-manifest.json",
  JSON.stringify({ swaps, skipped }, null, 2),
);
