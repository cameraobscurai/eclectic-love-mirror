...
function ThanksPage() {
  return (
    <div className="min-h-screen bg-cream text-charcoal grid place-items-center px-6">
      <div className="max-w-md text-center">
        ...
        <p className="mt-4 text-[11px] uppercase tracking-[0.22em] text-charcoal/60 leading-relaxed">
