...
export const ATELIER_IMAGE_ALT = {
  HERO_IMAGE:
    "Atelier moodboard — tasseled bench portrait taped beside antique linen, French silk, and Mruday snow sheer fabric swatches.",
  HIVE_TRIPTYCH:
  ...
  WORKSHOP_COLLAGE: "Studio collage — fabrication, sketching, and finished detail.",
} as const;
